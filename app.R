  ...
  page_navbar(
    title = div(
      tags$a(href = "https://healthcampusdenhaag.nl/nl/", target = "_blank",
             img(src="www/images/hc-dh-logo.svg") # Updated path
      ),
    ),
  ...
  div(
    ...
    div(
      ...
      div(
        class = "footer-logo",
        tags$a(href = "https://healthcampusdenhaag.nl/nl/", target = "_blank",
               img(src="www/images/hc-dh-logo.svg")
        )
      ),
      div(
        class = "footer-col-1",
      ...
      div(
        ...
        div(
          ...
          div(
            ...
            tags$a(href = "https://healthcampusdenhaag.nl/nl/", target = "_blank",
                   img(src="www/images/lumc.svg", alt="LUMC")
            )
          ),
          div(
            class = "main-sponsor-logo",
            tags$a(href = "https://healthcampusdenhaag.nl/nl/", target = "_blank",
                   img(src="www/images/universiteit_leiden.svg", alt="Universiteit Leiden")
            )
          )
        )
      ),
    ...
    div(
      ...
      div(
        ...
        div(
          class = "partner-logo",
          img(src="www/images/Partner/logo1-rgb.svg", alt="Partner 1")
        ),
...
#footer links and modal dialogs 
